...
import BadgeBtnWithGas from "../Buttons/BadgeBtnWithGas";
import BadgeBtnWithGasless from "../Buttons/BadgeBtnWithGasless";
...
const BadgeForm = () => {
  ...
  return (
    <div className="form badge-form">
      ...
      <BadgeBtnWithGasless {...badgeInput} />
      <BadgeBtnWithGas {...badgeInput} />
    </div>
  );
};
